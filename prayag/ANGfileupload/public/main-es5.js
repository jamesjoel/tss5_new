...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<a routerLink=\"/\" class=\"btn btn-primary\">Home</a>\n\n<router-outlet></router-outlet>";
    /***/
  },
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppPagesHomeHomeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<br>\n\n<div class=\"container\">\n    <div class=\"row\">\n        <!-- <h5>{{ path }}</h5> -->\n        <input type=\"file\" (change)=\"upload($event.target.files)\" class=\"m-0 p-0\">\n        \n    </div>\n    <div class=\"row\">\n        <button class=\"btn btn-success\" (click)=\"pushFile()\">Upload</button>\n    </div>\n    <div *ngIf=\"path\" class=\"row\">\n        <img src=\"{{ path }}\" />\n    </div>\n</div>";
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _pages_home_home_component__WEBPACK_IMPORTED_MODULE_7__["HomeComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]],
      providers: [],
  ...
  function srcAppPagesHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_upload_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function HomeComponent(_upload, _form) {
      ...
      _createClass(HomeComponent, [{
        ...
        key: "upload",
        value: function upload(fileArr) {
          this.form = this._form.selectFile(fileArr[0], "image"); // this._upload.upload(this.form).subscribe(data => {
          //   console.log(data);
        ...
        key: "pushFile",
        value: function pushFile() {
          var _this = this;

          this._upload.upload(this.form).subscribe(function (data) {
            console.log(data);
            _this.path = data.fileUrl;
          }, function (err) {
            console.log(err);
          });
        }
  ...
  function srcAppServicesFormsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(FormsService, [{
        key: "selectFile",
        value: function selectFile(file, name) {
    ...
    function () {
      ...
      _createClass(UploadService, [{
        ...
        value: function upload(data) {
          return this._http.post("http://localhost:3000/api/fileupload", data);
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Nodejs\tss5_new\prayag\ANGfileupload\ngfileup\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
